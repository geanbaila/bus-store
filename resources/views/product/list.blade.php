...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">Productos</span>
        </h3>
            ...
            <table class="table align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="fw-bolder text-muted bg-light">
                        <th class="ps-4 min-w-325px rounded-start">Producto</th>
                        <th class="min-w-125px">Precio venta</th>
                        <th class="min-w-125px">Stock</th>
                        <th class="min-w-200px">Agencia</th>
                ...
                <tbody>
                    @isset($prg_producto)
                    @foreach ($prg_producto as $row_producto)
                    <tr>
                        <td>
